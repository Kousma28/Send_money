...
class _PinConfirmScreenState extends State<PinConfirmScreen> with TickerProviderStateMixin {
          ...
          child: Opacity(
            ...
            child: Column(
              ...
              children: [
                ...
                const Text(
                  'Entrez à nouveau votre code PIN à 4 chiffres pour le confirmer',
                  style: TextStyle(
                    fontSize: 16,
